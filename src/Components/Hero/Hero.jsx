...
const Hero = () => {
  return (
    <section className="bg-gradient-to-br from-indigo-900 via-blue-900 to-purple-800 rounded-3xl px-6 py-16 mx-4 md:mx-20 lg:mx-40 mb-10 shadow-lg flex flex-col items-center animate-fadeInUp max-w-7xl mx-auto">
